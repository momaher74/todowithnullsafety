                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var newItem = cubit.deletedTasks[index];
                      return Container(
                            ...
                            Row(
                              children: [
                                MyElevetedButton(
                                  ...
                                  function: () {
                                    cubit.updateData(status: 'new', id: newItem['id']);
                                  },
                                  width: 160,
                                ),
                                ...
                                MyElevetedButton(
                                  ...
                                  function: () {
                                    cubit.deleteData(id: newItem['id']);
                                  },
                                  width: 160,
                                ),
                              ],
                  ...
                  if(state is ! GetLoadingState && cubit.deletedTasks.isEmpty )
                    Column(
                      children: [
                        MyHeightSizedBox(x: 200) ,
                        const Icon(Icons.list_alt  ,size: 150, color: Colors.white,) ,
